...
@section('title', 'Tambah Data Laporan Kinerja Harian')
    ...
    @if ($absenMasuk && !$absenPulang)
        <div class="card w-100 position-relative overflow-hidden">
            <div class="mt-2 mb-3 text-center">
                <h4 class="fw-semibold mb-0">Laporan Kinerja Harian</h4>
            </div>
            ...
            <div class="card-body p-4">
                <form action="{{ route('laporankinerja.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-xl-4 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="date" name="tanggal_kegiatan" class="form-control" autocomplete="off"
                                    value="{{ $getJamKehadiran->tanggal ?? null }}" readonly>
                        ...
                        <div class="col-xl-4 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="time" name="jam_mulai" class="form-control" autocomplete="off"
                                    value="{{ $getJamKehadiran->jam_absen ?? '01:00' }}" readonly>
                                @error('jam_mulai')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-xl-4 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="time" name="jam_berakhir" class="form-control"
                                    placeholder="Masukkan Tempat Lahir" value="{{ $jamPulang ?? null }}" readonly>
                                @error('jam_berakhir')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-xl-12 col-sm-12">
                            <div class="mb-3">
                                ...
                                <textarea autocomplete="off" name="keterangan_kegiatan" class="form-control text-capitalize" rows="8"
                                    placeholder="Masukkan Deskripsi Kegiatan...">{{ old('keterangan_kegiatan') }}</textarea>
