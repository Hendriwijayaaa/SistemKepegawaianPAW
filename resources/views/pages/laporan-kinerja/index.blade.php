...
@section('content')
    ...
    @elseif (Auth::user()->role === 'tu')
        @if ($data_get->count() > 0)
            <div class="card w-100 position-relative overflow-hidden">
                <div class="mt-2 mb-3 text-center">
                    <h5 class="fw-semibold mb-0 mt-3">Verifikasi Laporan Kinerja Harian</h5>
                </div>
                <div class="container">
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            <form action="{{ route('laporankinerja.accAllByTu') }}" method="POST">
                                @csrf
                                <button type="submit" class="btn btn-primary">Verifikasi Acc Semua Laporan</button>
                            </form>
                        </div>
                        <div class="col-sm">
                            <div class="d-flex justify-content-sm-end">
                                                        ...
                                                        <form action="{{ route('laporankinerja.tolak', $data->id) }}"
                                                            ...
                                                            <li>
                                                                <button type="submit"
                                                                    ...
                                                                    <i
                                                                        class="ri-dislike-fill align-bottom me-2 text-muted"></i>
                                                                    Tolak Laporan
                                                                </button>
                                                            </li>
                                                        </form>
