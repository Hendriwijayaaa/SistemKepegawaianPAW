...
<body>
    ...
    <table style="margin-bottom: 8px;">
        <tr>
            ...
            <td>:</td>
            <td><span style="font-size: 12px;">{{ $laporanPertama->pegawai->nama_lengkap }}</span></td>
        </tr>
        <tr>
            <td><strong style="font-size: 12px;">Jabatan</strong></td>
            <td>:</td>
            <td><span
                    style="font-size: 12px; text-transform: capitalize;">{{ $laporanPertama->pegawai->jabatan }}</span>
            </td>
        </tr>
    </table>
    <table style="border-collapse: collapse; width: 100%; text-transform: capitalize;">
        ...
        <tbody>
            @php
                $no = 1;
            @endphp
            @foreach ($laporanGroupedByPegawai as $data)
                <tr>
